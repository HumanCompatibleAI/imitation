...
def objective_cheetah(trial):
    ...
    total_timesteps = trial.suggest_int("total_timesteps", 1000, 1_000_000, log=True)
...
def perform_cheetah_trial():
    ...
    study_name = "cheetah_trial_short_max_length"  # Unique identifier of the study.
    storage_name = "sqlite:///{}.db".format(study_name)
    study = optuna.create_study(study_name=study_name, storage=storage_name, load_if_exists=True, direction='maximize')

    study.optimize(objective_cheetah, n_trials=10, n_jobs=1)
