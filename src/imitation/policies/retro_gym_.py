...
# flake8: noqa
# pylint: skip-file
# This code is adapted from the MIT-licensed OpenAI Retro at:
...
class RetroInteractive(Interactive):
    ...
    def __init__(self, env, sync=False, tps=60, aspect_ratio=4 / 3):
        self._buttons = env.buttons
        super().__init__(env=env, sync=sync, tps=tps, aspect_ratio=aspect_ratio)
