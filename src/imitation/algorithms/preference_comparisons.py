...
class TrajectoryDataset(TrajectoryGenerator):
    ...
    def __init__(
        ...
        Args:
            ...
            rng: Random state for RNG used for shuffling dataset.
            custom_logger: Where to log to; if None (default), creates a new logger.
        """
...
class AgentTrainer(TrajectoryGenerator):
    ...
    def __init__(
        ...
        Args:
            ...
            rng: random state used for exploration and for sampling.
...
class RandomFragmenter(Fragmenter):
    ...
    def __init__(
        ...
        Args:
            rng: the random state for the random number generator
...
class PreferenceGatherer(abc.ABC):
    ...
    def __init__(
        ...
        Args:
            rng: random state for random number generation, if applicable.
            custom_logger: Where to log to; if None (default), creates a new logger.
        """
...
class SyntheticGatherer(PreferenceGatherer):
    ...
    def __init__(
        ...
        Args:
            ...
            rng: random state for the internal RNG
...
class PreferenceComparisons(base.BaseImitationAlgorithm):
    ...
    def __init__(
        ...
        Args:
            ...
            rng: random state to use for initializing subcomponents such as
                fragmenter.
