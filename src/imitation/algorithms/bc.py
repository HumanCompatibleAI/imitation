...
class BehaviorCloningTrainer:
    ...
    def __call__(self, demonstration_data: Iterable[algo_base.TransitionMapping]):
...
def enumerate_batches(batch_it: Iterable[algo_base.TransitionMapping]) -> Iterable[Tuple[Tuple[int, int, int], algo_base.TransitionMapping]]:
